...
def test_file_has_no_markdown_errors(filepath):
    ...
    with subprocess.Popen("pymarkdown -d heading-style,blanks-around-headings scan, first-line-heading,first-line-h1, single-trailing-newline scan " + filepath,  # noqa: 501 pylint: disable=line-too-long
